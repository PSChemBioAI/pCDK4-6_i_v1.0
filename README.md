...
It is an online tool hosted on Google Colab that predicts the CDK4/6 inhibitory activity of small molecules (1 = Active, 0 = Inactive) and also enables molecular visualization.
___
...
3: Provide the SMILES notation of you query moleucle and run the cell.

4: Click the icon to visualize the chemical Space.
